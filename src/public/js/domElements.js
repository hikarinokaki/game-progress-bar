...
export const selectedGameDiv = document.getElementById("selected-game");

export const startInput = document.getElementById("startInput");
export const maxInput = document.getElementById("maxInput");
export const percentInput = document.getElementById("percentInput");
export const startTimeInput = document.getElementById("startTimeInput");
export const maxTimeInput = document.getElementById("maxTimeInput");
